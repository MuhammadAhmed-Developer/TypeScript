...
var calculate = width * height
if(width > height){
  console.log(`Its a Rectangle`)
}else{
  console.log(`Its not a Rectangle Because Height is greater then width`);
...
if(numberCheck>1){
  ...
  console.log(`${numberCheck} is equal to Zero`);
...
var calnum:number = ((10 + 5) * 3 - 2) / (4 % 3)  - 7
var step1:number = (15*3-2) / 1-7
var step2:number= 43/1-7
var step3:number= 43-7
var finalstep:number = 36
console.log(calnum);
